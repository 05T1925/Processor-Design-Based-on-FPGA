...
HD_PWD='C:/Users/rolle/Processor-Design-Based-on-FPGA/processor_fpga/processor_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minisys_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minisys_top.tcl -notrace
