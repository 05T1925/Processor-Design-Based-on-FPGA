...
HD_PWD='C:/Users/rolle/Processor-Design-Based-on-FPGA/processor_fpga/processor_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minisys_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minisys_top.tcl
