...
| `reports/tables/` | D+A | `perf_comparison.md`, `ppa_comparison.md`, `test_results.md`, `pipeline_hazard_analysis.md` 🆕, `branch_prediction_stats.md` 🆕, `pipeline_ppa_estimates.md` 🆕 | ✅ 6 个报告 |
